...
- The clean seam for Issue #22 is to keep `DispatchCoordinator` as the StoreOps facade while pushing route planning, driver assignment, dispatch queueing, and delivery tracking into separate interface-first services backed by configuration-driven dispatch rules and shared routing contracts.
