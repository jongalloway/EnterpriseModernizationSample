...
- 2026-05-18T01:39:47.894-07:00: Reporting batch work lands best when `Fabrikam.EnterprisePizza.Reporting.Batch` owns the nightly scheduler and ETL job catalog, while `Fabrikam.EnterprisePizza.Integrations.PosSync` contributes a payroll-feed importer adapter that stages external workforce rows into `DataSet` tables before Reporting aggregation.
