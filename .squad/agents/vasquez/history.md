...
- 2026-05-18T01:39:47.894-07:00: Partner profitability batch work lands best when `Fabrikam.EnterprisePizza.Reporting.Batch` keeps the nightly scheduler thin, then composes revenue, commission, and chargeback analytics over CustomerHub partner snapshots instead of baking financial assumptions into the console entry point.
- 2026-05-18T01:39:47.894-07:00: Reporting deployment should pull `data\sqlserver\before\Reporting\06-partner-profitability-reporting-stubs.sql` through `data\sqlserver\before\Deploy\00-deploy-all.sql` so DBAs see the partner scorecard aggregation seam alongside the rest of the nightly reporting estate.
