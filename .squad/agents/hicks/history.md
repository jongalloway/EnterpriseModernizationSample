...
- **2026-05-18T01:39:47.894-07:00:** Partner and franchise management reads cleanest as classic binder pages inside `src\before\Fabrikam.EnterprisePizza.Portal`, with `ObjectDataSource`-backed Web Forms pages for signup, contract review, referral tracking, and dashboard metrics sitting on top of a local repository class instead of inventing a cleaner modern web stack.
