...
- `Migration\01-run-nightly-sync.sql` - drives the CustomerHub extract, StoreOps cache refresh, and Reporting rollup procedures in sequence, including staged extract retention and removal-aware partner cache refresh
