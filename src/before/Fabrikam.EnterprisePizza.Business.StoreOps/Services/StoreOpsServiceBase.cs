...
{
    public abstract class StoreOpsServiceBase
    {
        ...
        private static Exception HandleException(Exception exception, string operationName)
        {
            ...
            var boundaryException = new InvalidOperationException("StoreOps business operation failed: " + operationName + ".", exception);
